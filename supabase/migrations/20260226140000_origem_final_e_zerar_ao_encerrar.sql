-- origem_final: quem continuará a conversa (agente/atendente). Zerado ao encerrar.
-- origem_inicial: incluir 'atendente' como quem iniciou. Zerado ao encerrar.

-- 1. Coluna origem_final
ALTER TABLE public.conversas
  ADD COLUMN IF NOT EXISTS origem_final text
  CHECK (origem_final IS NULL OR origem_final IN ('agente', 'atendente'));
